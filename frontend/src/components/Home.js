...
const Home = () => {
    ...
    [])
    const langs = [...new Set(Object.values(data.language))]

    const [selectedLang, setSelectedLang] = useState(langs[0])
    const [plot, setPlot] = useState(0)
    
    
    const qryUsersPerLang = [Object.values(data.users), Object.values(data.language)]
    const qryAllPoints = [Object.values(data.total_points_all_challenges), Object.values(data.language)]
    const qryPoints = [Object.values(data.points), Object.values(data.language)]
    const qryEasySolved = [Object.values(data.total_easy_solved), Object.values(data.language)]
    const qryMedSolved = [Object.values(data.total_medium_solved), Object.values(data.language)]
    const qryHardSolved = [Object.values(data.total_hard_solved), Object.values(data.language)]
